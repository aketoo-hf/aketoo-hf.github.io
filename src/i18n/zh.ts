...
export const zh: Dict = {
  ...
  chat: {
    ...
    chips: ['如何申请试样？', '两款产品有什么区别？', '有哪些认证体系？', '可以定制配方吗？'],
    faq: [
      {
        id: 'sampling',
      ...
      {
        id: 'flexibility',
        keywords: ['折弯', '柔韧', '弯曲', '开裂', '母排', '铜排', 'flex', 'busbar'],
        answer:
          '高柔韧性长母排专用环氧绝缘粉末专为AI算力中心超大铜铝长母排浸涂工艺定制研发，柔韧性优异、耐反复弯折、耐压稳定，耐高温性能突出。具体工艺参数请与我们的工程团队确认。',
      },
      {
        id: 'certification',
  ...
  seo: {
    ...
    products: {
      ...
      description:
        '高柔韧性长母排专用环氧绝缘粉末，专为AI算力中心超大铜铝长母排浸涂工艺定制研发；高性能PVC绝缘浸塑溶胶，耐高低温、绝缘阻值稳定、防腐防护优异。均支持配方定制与快速打样。',
    },
    applications: {
